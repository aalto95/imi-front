...
export const Header = () => {
  ...
  return (
    <>
      <header className="h-18 px-4 sm:px-8 md:px-12 xl:px-24 2xl:px-32 bg-white w-full fixed md:static z-10">
        ...
        <nav className="hidden md:visible md:flex md:justify-between md:pb-4">
          {
